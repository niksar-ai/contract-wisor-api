...
* The original package name 'ai.niksar.contract-wisor-api' is invalid and this project uses 'ai.niksar.contract_wisor_api' instead.
...
Due to Maven's design, elements are inherited from the parentID POM to the project POM.
While most of the inheritance is fine, it also inherits unwanted elements like `<license>` and `<developers>` from the parentID.
To prevent this, the project POM contains empty overrides for these elements.
If you manually switch to a different parentID and actually want the inheritance, you need to remove those overrides.
